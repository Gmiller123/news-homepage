...
const Navbar = () => {
  return (
    <header className="  py-10 shadow-lg max-sm:px-10">
      <nav className="container mx-auto flex items-center justify-between">
        ...
        <div className="lg:block hidden">
          <ul className=" flex items-center justify-center space-x-10 text-xl capitalize tracking-wide font-bold text-slate-500 cursor-pointer">
            <li>
              <a href=""></a>Home
            </li>
            <li>
